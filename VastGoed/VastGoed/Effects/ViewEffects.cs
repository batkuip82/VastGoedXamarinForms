...
namespace VastGoed.Effects
{
    //http://xfcomplete.net/general/2016/01/20/using-effects/ --> seems not to work?
    //https://developer.xamarin.com/guides/xamarin-forms/effects/passing-parameters/attached-properties/
